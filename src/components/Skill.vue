      ...
      <div class="row clearfix">
      	...
      	<div class="u-col-6">
      		<div class="card">
      			...
      			<div class="item">CSS3, Sass</div>
      			<div class="item">RWD, Bootstrap</div>
      		</div>
      	</div>
      	<div class="u-col-6">
      		<div class="card">
      	...
      	<div class="u-col-6">
      		<div class="card">
      			...
      			<div class="item">Vuex</div>
      		</div>
      	</div>
      	<div class="u-col-6">
      		<div class="card">
      			<div class="icon">
      				<img src="../images/coding.png" alt="others">
      			</div>
      			<div class="skill-title">Others</div>
